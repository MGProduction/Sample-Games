// Z@xxonClone.cpp : definisce il punto di ingresso dell'applicazione.
//

#include "stdafx.h"
#include "Z@xxonClone.h"
                     ...
                     int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_ZXXONCLONE, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_ZXXONCLONE));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_ZXXONCLONE));
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_ZXXONCLONE);
