...
#define JNI_GAME_CLASS "com/marcogiorgini/World2D/GameJNI"
...
//////////////////////////////////////////////
JNIEXPORT void JNICALL Java_com_marcogiorgini_World2D_GameJNI_initGame(JNIEnv* env, jclass c, jstring data_path, jstring save_path, jint width, jint height, jint mode)
{
	jboolean iscopy;
	const jbyte* path1;
	const jbyte* path2;
...
JNIEXPORT void JNICALL Java_com_marcogiorgini_World2D_GameJNI_setOrientationGame(JNIEnv* env, jclass c, jint portrait, jint width, jint height,  jint flip)
{
	game_set_orientation(portrait, width, height, flip);	
}

JNIEXPORT void JNICALL Java_com_marcogiorgini_World2D_GameJNI_drawGame(JNIEnv* env, jclass c)
{
	game_draw();
}

JNIEXPORT void JNICALL Java_com_marcogiorgini_World2D_GameJNI_destroyGame(JNIEnv* env, jclass c)
{
	game_destroy();
}

JNIEXPORT void JNICALL Java_com_marcogiorgini_World2D_GameJNI_pauseGame(JNIEnv* env, jclass c)
{
	game_pause();
}

JNIEXPORT void JNICALL Java_com_marcogiorgini_World2D_GameJNI_resumeGame(JNIEnv* env, jclass c)
{
	game_resume();
}

JNIEXPORT void JNICALL Java_com_marcogiorgini_World2D_GameJNI_restoreGameTextures(JNIEnv* env, jclass c)
{
	game_restore_textures();
}

JNIEXPORT void JNICALL Java_com_marcogiorgini_World2D_GameJNI_keyEvent(JNIEnv* env, jclass c, jint key, jint state)
{
	game_key_event(key, state);
}

JNIEXPORT void JNICALL Java_com_marcogiorgini_World2D_GameJNI_touchEvent(JNIEnv* env, jclass c, jint id, jint action, jint x, jint y)
{
	game_touch_event(id, action, x, y);
}

JNIEXPORT void JNICALL Java_com_marcogiorgini_World2D_GameJNI_accelEvent(JNIEnv* env, jclass c, jfloat x, jfloat y, jfloat z)
{
